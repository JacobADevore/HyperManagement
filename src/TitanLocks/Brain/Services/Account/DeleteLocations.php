...
class DeleteLocations
{
    ...
    public function requirementCheckLocationName($adminId, $locationName) {
        ...
        if ($count != 1) {
            // returns error alert
            $this->alert['error'] = 'Invalid location name, we could\'t find a '.$locationName.' under your account location name list. please refresh and try again';
            return false;
        }
    ...
    public function deleteLocation() {
        ...
        $result = $datastore->delete($datastore->key('Locations', $this->datastoreLocationId));
