...
namespace TitanLocks\AdminDashBundle\Controller;
...
class BrainController extends Controller
{
    ...
    public function dashboardAction()
    {
        ...
        if ($authentication->authenticationInformation['type'] != 1) {
    ...
    /**
     * @Route("/change/email", name="admin/dashboard/change/email")
     */
    public function changeEmailAction()
    {
        ...
        if (isset($_POST['newEmail']) && isset($_POST['reEnteredNewEmail']) && isset($_POST['password'])) {
            ...
            if ($emailChange->success == true) {
                ...
                return $this->render('@AdminDash/ChangeEmail.html.twig', $authentication->authenticationInformation);
            } else {
                return $this->render('@AdminDash/ChangeEmail.html.twig', array_merge($authentication->authenticationInformation,$emailChange->alert));
            }
        }
        ...
        if (isset($_GET['emailVerificationId']) && isset($_GET['secret'])) {
            ...
            if ($emailChangeVerification->success == true) {
                ...
                return $this->redirectToRoute('admin/dashboard/change/email');
            } else {
                return $this->render('@AdminDash/ChangeEmail.html.twig', array_merge($authentication->authenticationInformation,$emailChangeVerification->alert));
            }
        }
    ...
    /**
     * @Route("/change/password", name="admin/dashboard/change/password")
     */
    public function changePasswordAction()
    {
        ...
        if (isset($_POST['password']) && isset($_POST['newPassword']) && isset($_POST['reEnteredNewPassword'])) {
            ...
            if ($passwordChange->success == true) {
                ...
                return $this->render('@AdminDash/ChangePassword.html.twig');
            } else {
                return $this->render('@AdminDash/ChangePassword.html.twig', array_merge($authentication->authenticationInformation,$passwordChange->alert));
            }
        }

        return $this->render('@AdminDash/ChangePassword.html.twig', $authentication->authenticationInformation);
    }

    /**
     * @Route("/manage/jobtitles", name="admin/dashboard/manage/jobtitles")
     */
    public function manageJobTitlesAction()
    {
        ...
        $query = $datastore->query()
            ->kind('JobTitles')
            ->filter('adminUserId', '=', $authentication->authenticationInformation['userId']);
        ...
        if (isset($_POST['jobTitleName'])) {
            ...
            $manageJobTitlesCreate = new CreateJobTitle($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin', $_POST['jobTitleName'], $features);
            ...
            if ($manageJobTitlesCreate->success == true) {
                ...
                return $this->redirectToRoute('admin/dashboard/manage/jobtitles');
            } else {
                return $this->render('@AdminDash/ManageJobTitles.html.twig', array_merge(array_merge($authentication->authenticationInformation,$manageJobTitlesCreate->alert), array('jobTitles' => $jobTitles)));
            }
        }

        if (isset($_POST['delete'])) {
            $manageJobTitlesDelete= new DeleteJobTitle($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin', $_POST['delete']);
            ...
            if ($manageJobTitlesDelete->success == true) {
                ...
                return $this->render('@AdminDash/ManageJobTitles.html.twig', array_merge(array_merge($authentication->authenticationInformation,$manageJobTitlesDelete->alert), array('jobTitles' => $jobTitles)));
            }
        }
        ...
        if (isset($_GET['jobTitleName'])) {
            ...
            if (isset($_POST['jobTitleNameEdit'])) {
                ...
                $manageJobTitlesEdit = new EditJobTitle($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin', $_POST['jobTitleOldName'], $_POST['jobTitleNameEdit'], $features);
            ...
            if ($datastoreErrorHandling != false) {
                // returns error alert
                return $this->render('@AdminDash/EditJobTitles.html.twig', array_merge($authentication->authenticationInformation,array('jobTitle' => $jobTitle, 'features' => $features, 'error' => 'Issue trying to find job title, please refresh and try again. if that does\'t work people retry the process')));
            }
            ...
            return $this->render('@AdminDash/EditJobTitles.html.twig', array_merge($authentication->authenticationInformation,array_merge(array('jobTitle' => $jobTitle, 'features' => $features), $alerts)));
        }

        return $this->render('@AdminDash/ManageJobTitles.html.twig', array_merge($authentication->authenticationInformation, array('jobTitles' => $jobTitles)));
    }

    /**
     * @Route("/manage/users", name="admin/dashboard/manage/users")
     */
    public function manageUsersAction()
    {
        ...
        if (isset($_POST['email']) && isset($_POST['reEnteredEmail']) && isset($_POST['password']) && isset($_POST['jobTitle'])) {
            $manageUsersCreateUser= new CreateUser($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], $_POST['email'], $_POST['reEnteredEmail'], $_POST['password'], $_POST['jobTitle'], 'admin', $authentication->authenticationInformation['ttlUsername'], $authentication->authenticationInformation['ttlPassword']);
            ...
            if ($manageUsersCreateUser->success == true) {
                ...
                return $this->redirectToRoute('admin/dashboard/manage/users');
            } else {
                return $this->render('@AdminDash/ManageUsers.html.twig', array_merge(array_merge($authentication->authenticationInformation, $manageUsersCreateUser->alert), array('users' => $users, 'jobTitles' => $jobTitles)));
            }
        }

        if (isset($_POST['delete'])) {
            $manageUsersDeleteUser= new DeleteUser($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], $_POST['delete'], $authentication->authenticationInformation['jobTitle']);
            ...
            if ($manageUsersDeleteUser->success == true) {
                ...
                return $this->render('@AdminDash/ManageUsers.html.twig', array_merge(array_merge($authentication->authenticationInformation,$manageUsersDeleteUser->alert), array('users' => $users, 'jobTitles' => $jobTitles)));
            }
        }
        ...
        if (isset($_GET['userId'])) {
            ...
            if (isset($_POST['userEmail']) && isset($_POST['userPassword']) && isset($_POST['userJobTitle'])) {
                ...
                $editUsers = new EditUsers($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], $_GET['userId'], 'admin', $_POST['userEmail'], $_POST['userPassword'], $_POST['userJobTitle']);
            ...
            return $this->render('@AdminDash/EditUsers.html.twig', array_merge($authentication->authenticationInformation, array_merge(array('email' => $userEmail, 'userJobTitle' => $userJobTitle, 'jobTitles' => $jobTitles), $alerts)));
        }

        return $this->render('@AdminDash/ManageUsers.html.twig', array_merge($authentication->authenticationInformation, array('users' => $users, 'jobTitles' => $jobTitles)));
    }

    /**
     * @Route("/manage/locations", name="admin/dashboard/manage/locations")
     */
    public function manageLocationsAction()
    {
        ...
        if (isset($_POST['locationName'])) {
            ...
            $createLocation = new CreateLocations($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin', $_POST['locationName']);
            ...
            if ($createLocation->success == true) {
                ...
                return $this->redirectToRoute('admin/dashboard/manage/locations');
            } else {
                $alerts = $createLocation->alert;
            }

            return $this->render('@AdminDash/ManageLocations.html.twig', array_merge($authentication->authenticationInformation, array_merge(array('locations' => $locations), $alerts)));
        ...
        if (isset($_GET['locationName'])) {
            ...
            if (isset($_POST['editLocationName'])) {
                ...
                $editLocations = new EditLocations($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin', $_GET['locationName'], $_POST['editLocationName']);
            ...
            return $this->render('@AdminDash/EditLocations.html.twig', array_merge($authentication->authenticationInformation, array_merge(array('locationName' => $_GET['locationName']), $alerts)));
        }

        if (isset($_POST['delete'])) {
            $deleteLocations= new DeleteLocations($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin', $_POST['delete']);
            ...
            if ($deleteLocations->success == true) {
                ...
                return $this->render('@AdminDash/ManageLocations.html.twig', array_merge($authentication->authenticationInformation, array_merge(array('locations' => $locations), $deleteLocations->alert)));
            }
        }

        return $this->render('@AdminDash/ManageLocations.html.twig', array_merge($authentication->authenticationInformation, array('locations' => $locations)));
    }

    /**
     * @Route("/manage/locks", name="admin/dashboard/manage/locks")
     */
    public function manageLocksAction()
    {
        ...
        if (isset($_GET['lockName'])) {
            ...
            if (isset($_POST['editLockName']) && isset($_POST['editLocationName'])) {
                $editLock = new EditLock($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin',$_GET['lockName'], $_POST['editLockName'], $_POST['editLocationName']);

                // checks if EmailChangeVerification was a success
                if ($editLock->success == true) {
                    $this->get('session')->getFlashBag()->set('success', 'Lock '.$_GET['lockName'].' successfully edited');
                    return $this->redirectToRoute('admin/dashboard/manage/locks');
                } else {
                    return $this->render('@AdminDash/EditLocks.html.twig', array_merge(array_merge($authentication->authenticationInformation, array('lockLocations' => $editLockLocations)), array_merge($editLock->alert, array('lock' => $lockInfomation))));
                }
            }

            return $this->render('@AdminDash/EditLocks.html.twig', array_merge(array_merge($authentication->authenticationInformation, array('lockLocations' => $editLockLocations)), array('lock' => $lockInfomation)));
        }
        ...
        if (isset($_POST['lockName']) && isset($_POST['locationName']) && isset($_POST['lockNumber'])) {
            $createLock= new CreateLock($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin', $_POST['lockName'], $_POST['locationName'], $_POST['lockNumber'], $authentication->authenticationInformation['ttlUsername'], $authentication->authenticationInformation['ttlPassword']);
            ...
            if ($createLock->success == true) {
                ...
                return $this->render('@AdminDash/ManageLocks.html.twig', array_merge($authentication->authenticationInformation, array_merge(array('locks' => $locks, 'apiLockList' => $apiLockList), array_merge($alerts, array_merge(array('lockNumbers' => $lockNumbers), array_merge(array( 'lockLocations' => $lockLocations), $createLock->alert))))));
            }
        }

        if (isset($_POST['delete'])) {
            $deleteLock= new DeleteLock($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin', $_POST['delete']);
            ...
            if ($deleteLock->success == true) {
                ...
                return $this->render('@AdminDash/ManageLocks.html.twig', array_merge($authentication->authenticationInformation, array_merge(array('locks' => $locks, 'apiLockList' => $apiLockList), array_merge($alerts, array_merge(array('lockNumbers' => $lockNumbers), array_merge(array( 'lockLocations' => $lockLocations), $deleteLock->alert))))));
            }
        }

        return $this->render('@AdminDash/ManageLocks.html.twig', array_merge($authentication->authenticationInformation, array_merge(array('locks' => $locks, 'apiLockList' => $apiLockList), array_merge($alerts, array_merge(array('lockNumbers' => $lockNumbers), array( 'lockLocations' => $lockLocations))))));
    }

    /**
     * @Route("/manage/passcodes", name="admin/dashboard/manage/passcodes")
     */
    public function managePasscodesAction()
    {
        ...
        if (isset($_POST['passcode']) && isset($_POST['startTime']) && isset($_POST['endTime']) && isset($_POST['lockName']) && isset($_POST['passcodeType']) && isset($_POST['passcodeGenerate'])) {
            $createPasscode= new CreatePasscode($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin', $_POST['passcode'], $_POST['startTime'], $_POST['endTime'], $_POST['lockName'], $_POST['passcodeType'], $_POST['passcodeGenerate'], $authentication->authenticationInformation['ttlUsername'], $authentication->authenticationInformation['ttlPassword']);
            ...
            if ($createPasscode->success == true) {
                ...
                return $this->redirectToRoute('admin/dashboard/manage/passcodes');
            } else {
                return $this->render('@AdminDash/ManagePasscodes.html.twig', array_merge(array_merge($authentication->authenticationInformation, $createPasscode->alert), array_merge(array('lockList' => $locks), array('lockPasscodes' => $lockPasscodes))));
            }
        }

        if (isset($_POST['delete'])) {
            $deletePasscode= new DeletePasscode($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin', $_POST['delete'], $authentication->authenticationInformation['ttlUsername'], $authentication->authenticationInformation['ttlPassword']);
            ...
            if ($deletePasscode->success == true) {
                ...
                return $this->render('@AdminDash/ManagePasscodes.html.twig', array_merge($authentication->authenticationInformation, array_merge(array('lockList' => $locks), array_merge(array('lockPasscodes' => $lockPasscodes), $deletePasscode->alert))));
            }
        }
        ...
        if (isset($_GET['passcodeId']) && isset($_GET['lockId']) && isset($_GET['passcode']) && isset($_GET['lock'])) {
            ...
            if (isset($_POST['editPasscode']) && isset($_POST['editStartTime']) && isset($_POST['editEndTime'])) {
                $editPasscode= new EditPasscode($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin', $_POST['editPasscode'], $_POST['editStartTime'], $_POST['editEndTime'], $_GET['passcodeId'], $_GET['lockId'], $authentication->authenticationInformation['ttlUsername'], $authentication->authenticationInformation['ttlPassword']);
                ...
                if ($editPasscode->success == true) {
                    ...
                    return $this->render('@AdminDash/EditPasscodes.html.twig', array_merge(array_merge($authentication->authenticationInformation, array('lockList' => $locks)), array_merge($passcodeInformation, $editPasscode->alert)));
                }
            }

            return $this->render('@AdminDash/EditPasscodes.html.twig', array_merge($authentication->authenticationInformation, array_merge(array('lockList' => $locks), $passcodeInformation)));
        }

        return $this->render('@AdminDash/ManagePasscodes.html.twig', array_merge($authentication->authenticationInformation, array_merge(array('lockList' => $locks), array('lockPasscodes' => $lockPasscodes, 'locationsAndLocks' => $locationsAndLocks))));
    }

    /**
     * @Route("/manage/ekeys", name="admin/dashboard/manage/ekeys")
     */
    public function manageEkeysAction()
    {
        ...
        if (isset($_POST['username']) && isset($_POST['startTime']) && isset($_POST['endTime']) && isset($_POST['lockName']) && isset($_POST['remoteEnable'])) {
            ...
            if ($createEkey->success == true) {
                ...
                return $this->redirectToRoute('admin/dashboard/manage/ekeys');
            } else {
                return $this->render('@AdminDash/ManageEkeys.html.twig', array_merge(array_merge($authentication->authenticationInformation, $createEkey->alert), array_merge(array('lockList' => $locks), array('lockEkeys' => $lockEkeys))));
            }
        }

        if (isset($_POST['delete'])) {
            $deleteEkey = new DeleteEkey($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin', $_POST['delete'], $authentication->authenticationInformation['ttlUsername'], $authentication->authenticationInformation['ttlPassword']);
            ...
            if ($deleteEkey->success == true) {
                ...
                return $this->render('@AdminDash/ManageEkeys.html.twig', array_merge($authentication->authenticationInformation, array_merge(array('lockList' => $locks), array_merge(array('lockEkeys' => $lockEkeys), $deleteEkey->alert))));
            }
        }
        ...
        if (isset($_GET['ekeyid']) && isset($_GET['username'])) {
            ...
            if (isset($_POST['editStartTime']) && isset($_POST['editEndTime'])) {
                $editEkey = new EditEkey($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin', $_GET['ekeyid'], $_POST['editStartTime'], $_POST['editEndTime'], $authentication->authenticationInformation['ttlUsername'], $authentication->authenticationInformation['ttlPassword']);
                ...
                if ($editEkey->success == true) {
                    ...
                    return $this->render('@AdminDash/EditEkeys.html.twig', array_merge($authentication->authenticationInformation, array_merge(array('ekeyid' => $_GET['ekeyid'], 'lockId' => $_GET['lockId'], 'username' => $_GET['username']), $editEkey->alert)));
                }
            }

            return $this->render('@AdminDash/EditEkeys.html.twig', array_merge($authentication->authenticationInformation, array('ekeyid' => $_GET['ekeyid'], 'username' => $_GET['username'])));

        }


        return $this->render('@AdminDash/ManageEkeys.html.twig', array_merge($authentication->authenticationInformation, array_merge(array('lockList' => $locks), array('lockEkeys' => $lockEkeys))));
    }

    /**
     * @Route("/manage/maintenance", name="admin/dashboard/manage/maintenance")
     */
    public function manageMaintenanceAction()
    {
        ...
        if (isset($_POST['description']) && isset($_POST['urgency']) && isset($_POST['lockId'])) {
            $createMaintenance= new CreateMaintenance($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin', $_POST['description'], $_POST['urgency'], $_POST['lockId'], $authentication->authenticationInformation['ttlUsername'], $authentication->authenticationInformation['ttlPassword']);

            // checks if $manageJobTitlesCreate was a success
            if ($createMaintenance->success == true) {
                $this->get('session')->getFlashBag()->set('success', 'Maintenace Ticket successfully created');
                return $this->redirectToRoute('admin/dashboard/manage/maintenance');
            } else {
                return $this->render('@AdminDash/ManageMaintenance.html.twig', array_merge(array_merge($authentication->authenticationInformation, $createMaintenance->alert), array_merge(array('lockList' => $locks))));
            }
        }

        if (isset($_POST['completed'])) {
            $completeMaintenance= new CompleteMaintenance($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin', $_POST['completed']);
            ...
            if ($completeMaintenance->success == true) {
                ...
                return $this->render('@AdminDash/ManageMaintenance.html.twig', array_merge(array_merge($authentication->authenticationInformation, $completeMaintenance->alert), array('lockList' => $locks, 'maintenances' => $maintenance)));
            }
        }

        if (isset($_POST['delete'])) {
            $deleteMaintenance= new DeleteMaintenance($authentication->authenticationInformation['userId'], $authentication->authenticationInformation['userId'], 'admin', $_POST['delete']);
            ...
            if ($deleteMaintenance->success == true) {
                ...
                return $this->render('@AdminDash/ManageMaintenance.html.twig', array_merge(array_merge($authentication->authenticationInformation, $deleteMaintenance->alert), array('lockList' => $locks, 'maintenances' => $maintenance)));
            }
        }

        return $this->render('@AdminDash/ManageMaintenance.html.twig', array_merge($authentication->authenticationInformation, array('lockList' => $locks, 'maintenances' => $maintenance)));
    }

    /**
     * @Route("/viewunlockrecords", name="admin/dashboard/viewunlockrecords")
     */
    public function manageViewUnlockRecordsAction()
    {
        ...
        return $this->render('@AdminDash/ViewUnlockRecords.html.twig', array_merge($authentication->authenticationInformation, array('unlockRecords' => $unlockRecords, 'lockList' => $locks, 'pageValue' => $pageValue, 'currentLock' => $currentLock, 'lockId' => $lockId)));
    }
